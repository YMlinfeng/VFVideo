...
CRF = 23
def render_global():
    global_video_path = Path('test.mp4')
    #if global_video_path.exists():
    #    Log.info(f"[Render Global] Video already exists at {global_video_path}")
    #    return

    debug_cam = False
    pred = torch.load('/ytech_milm/Keling_HumanMotion/smpl_test/one-man/livephoto-body/livephoto-body-Kwai_50k/bodydance_download_new/ac/002717/000/video/hmr4d_results.pt')
    ...
    video_path = '/vh_share/lishunkai/smpl/GVHMR/static.mp4'
