...
if version.parse(pytorch_lightning.__version__) >= version.parse("2.0.0"):
    # Lightning 2.0 及以上，ProgressBar 是新的类名
    # https://lightning.ai/releases/2.0.0/
    from pytorch_lightning.callbacks.progress import ProgressBar
else:
    # Lightning 2.0 以下，使用 ProgressBarBase 并重命名为 ProgressBar
