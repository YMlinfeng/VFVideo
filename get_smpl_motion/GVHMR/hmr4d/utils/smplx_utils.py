...
def make_smplx(type="neu_fullpose", smpl_model_path='inputs', **kwargs):
    if type == "neu_fullpose":
        ...
        model = BodyModelSMPLX(model_path=smpl_model_path+"/body_models", **bm_kwargs)
        ...
        model = SmplxLiteV437Coco17(model_path = smpl_model_path) ##/ytech_milm/liujiwen/kling_motion_service/smpl_all_checkpoints/checkpoints/body_models/smplx
        ...
        bm_kwargs = {
            "model_path": smpl_model_path+"/body_models",
            "model_type": "smpl",
            "gender": "neutral",
            "num_betas": 10,
            "create_body_pose": False,
