...
class SmplxLite(nn.Module):
    def __init__(
        ...
        print ('smplx_path2222', smplx_path)
...
class SmplxLiteCoco17(SmplxLite):
    ...
    def __init__(self, **kwargs):
        ...
        COCO17_regressor = torch.load("hmr4d/utils/body_model/smpl_coco17_J_regressor.pt")
...
class SmplxLiteV437Coco17(SmplxLite):
    def __init__(self, model_path='./input/', **kwargs):
        super().__init__(**kwargs, model_path=model_path+'/body_models/smplx/')

        # Compute mapping (COCO17)
        smplx2smpl = torch.load(model_path+"/hmr4d/utils/body_model/smplx2smpl_sparse.pt")
        COCO17_regressor = torch.load(model_path+"/hmr4d/utils/body_model/smpl_coco17_J_regressor.pt")
        smplx2coco17 = torch.matmul(COCO17_regressor, smplx2smpl.to_dense())
        ...
        # Verts437
        smplx_vids2 = torch.load(model_path+"/hmr4d/utils/body_model/smplx_verts437.pt")
...
class SmplxLiteSmplN24(SmplxLite):
    ...
    def __init__(self, **kwargs):
        ...
        # Compute mapping
        smplx2smpl = torch.load("hmr4d/utils/body_model/smplx2smpl_sparse.pt")
        smpl2joints = torch.load("hmr4d/utils/body_model/smpl_neutral_J_regressor.pt")
