...
from ....model.gvhmr.utils.postprocess import (
    pp_static_joint,
    process_ik,
    pp_static_joint_cam,
)
from ....model.gvhmr.utils import stats_compose
...
from ....utils.geo.hmr_cam import compute_bbox_info_bedlam, compute_transl_full_cam, get_a_pred_cam, project_to_bi01
from ....utils.geo.hmr_global import (
...
class Pipeline(nn.Module):
    def __init__(self, args, args_denoiser3d, model_path, **kwargs):
        super().__init__()
        self.args = args
        ...
        # Normalizer
        self.endecoder: EnDecoder = instantiate(args.endecoder_opt, model_path=model_path, _recursive_=False)
