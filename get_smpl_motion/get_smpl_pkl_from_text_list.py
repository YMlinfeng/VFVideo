...
if __name__ == "__main__":
    ...
    text_path_list = open('/ytech_milm/liujiwen/kling_motion_service/get_smpl_motion/run_list_demo/text_path.txt').read().strip().split('\n')
    for i, input_file in enumerate(text_path_list):
        task_mode='text2motion'
        ...
        try:
            ...
            output_path = '/ytech_milm/liujiwen/kling_motion_service/get_smpl_motion/output/text/'+str(i)+'.pkl'
            print (input_text, output_path, 'error_code:', error_code)
            print 
            #输出写到本地用来调试:
